...
def simpan_proyek(request):
    try:
        ...
        cek_nama = Proyek.query.filter_by(nama_proyek=nama_proyek).first()
        if cek_nama:
            return {"message": "Proyek dengan nama <b>" + nama_proyek + "</b> sudah ada, silahkan ubah nama proyek!"}, 400
        else:
            ...
            db.session.commit()
            return {"message": "Proyek berhasil ditambahkan", "id_proyek": proyek.id}, 200
